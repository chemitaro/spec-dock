# Issue Planning Semantic Revision

Complete replacement uses prior Candidate, exact formal Review evidence, only selected P0/P1
findings and preserved assumptions; keep Issue, parent, repository, branch, source HEAD unchanged.

Subordinate; canonical precedence. 13 nonempty distinct H2s, exact labels, no split/merge: init-/epic-/iss- lineage; Purpose/scope; System context; Authority/responsibility; Current architecture/target architecture; ChatGPT First planning workflow; Provider-owned direct Oracle/reference-only chatgpt-use; Candidate/Review/Human/apply lifecycle; Exact branch failure; S01/S07/S08/S14 status/roadmap; Provider/projection; Failure modes; First-day checklist.
