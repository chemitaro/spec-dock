...
from spec_dock.installation.executor import apply_installation, prepare_installation
...
def _stage_missing(
    common_dir: Path, record: InstallationGroupRecord, bundle: VerifiedBundle
) -> InstallationGroupRecord:
