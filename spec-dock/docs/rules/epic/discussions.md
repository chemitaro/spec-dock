...
- Legacy create commands retained only for historical/preservation context; new working artifacts use `./spec-dock/scripts/spec-dock new artifact <type> --epic <id> --title "<title>"` and target `artifacts/`:
  - `./spec-dock/scripts/spec-dock new doc scratch --epic <id> --title "<title>"`
  - `./spec-dock/scripts/spec-dock new doc interview --epic <id> --title "<title>"`
