...
## 実装step
- S01: provider `.gitignore` の正本、現行 installer の対象範囲、配布済み旧版を確認する。
...
- AC-407-02: 配布済み旧版・欠落・独自編集の update / force-init 結果を確認する。
