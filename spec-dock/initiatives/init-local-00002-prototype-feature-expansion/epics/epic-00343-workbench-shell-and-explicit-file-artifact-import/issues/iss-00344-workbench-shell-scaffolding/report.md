...
| design | approved requirement、parent Epic、provider source、current copy / package contracts、ChatGPT planning candidate / design reviews | B-001〜B-006、NB-001/NB-002をcanonical designへ修正済み | partially_adopted | failed (`B-006`; prior findings修正済み) | yes | commit / push 後に fresh ChatGPT design re-review、その後 fresh `spec-reviewer` review |
