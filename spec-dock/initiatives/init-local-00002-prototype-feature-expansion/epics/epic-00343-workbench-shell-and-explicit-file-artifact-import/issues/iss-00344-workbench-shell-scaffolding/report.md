...
| plan | approved requirement/design、ChatGPT planning candidate、Standard assurance obligations、current provider/build/test seams | B-001/B-002をcanonical planへ修正し、fresh ChatGPT re-reviewでblocking/material/non-blocking findingなし | adopted | passed (ChatGPT advisory PASS; fresh `spec-reviewer` pending) | yes | fresh `spec-reviewer` plan review |
