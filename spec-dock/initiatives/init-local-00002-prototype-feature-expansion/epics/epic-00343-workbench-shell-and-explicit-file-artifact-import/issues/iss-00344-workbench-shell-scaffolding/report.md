...
| TC-344-007C | S02/S90 | EVD-006/EVD-008 | candidate | runtime rejectionはpass、4 docs guidance Green、fresh spec review pending |
...
| TC-344-010 | S90 | EVD-008 | candidate | exact semantic assertion `1 passed`、deprecated wording 0 hit、fresh spec review pending |
...
| S90 docs lane | doc-writer | 4 provider docsをshell/README-only tracking/security/authority/worktree copy/root/sibling Issue境界へ更新 | provider docs 3件、`templates/README.md` | exact docs + canonical asset `2 passed`; deprecated 3句 0 hit; canonical README diffなし; diff-check pass | fresh ChatGPT-Use `spec-reviewer`責務review pending | unresolved wordingなし。dogfood projectionはS95所有 | accepted as docs review candidate |
...
| S90 docs lane | docs candidate review | spec-reviewer | pending | pending | no | review exact pushed candidate | authority/security/copy/root/sibling境界とapproved specsをfresh reviewする |
...
| S90 docs lane | candidate | provider docs 4件、EAL-044、Green/delegation/closure candidate evidence | commit/push後にexact review targetを記録 | pending | not applicable | not applicable | not applicable | not applicable |
...
|---|---|---|---|---|
| provider docs 3件 + `templates/README.md`; workflow/skill/migration notesはsemantic changeなし | yes / N/A | doc-writer | exact semantic assertion + canonical asset `2 passed`; deprecated wording 0 hit; canonical README diffなし; dogfoodはS95 handoff | pending fresh spec-reviewer |
