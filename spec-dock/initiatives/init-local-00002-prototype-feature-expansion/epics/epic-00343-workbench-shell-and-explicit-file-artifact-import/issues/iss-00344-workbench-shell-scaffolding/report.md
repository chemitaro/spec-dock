...
| plan | approved requirement/design、ChatGPT planning candidate、Standard assurance obligations | 3つのvertical micro-batch、Closure Index、TDD、verification ladder、delegation、evidence、stop/handoffを正規化済み | partially_adopted | pending | yes | commit / push 後にChatGPT plan review、その後fresh `spec-reviewer` plan review |
