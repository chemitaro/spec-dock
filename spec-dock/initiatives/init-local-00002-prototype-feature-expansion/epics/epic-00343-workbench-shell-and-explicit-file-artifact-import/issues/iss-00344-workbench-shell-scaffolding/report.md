...
| plan | approved requirement/design、ChatGPT planning candidate、Standard assurance obligations、current provider/build/test seams、Issue plan authoring規約、delivery-boundary amendment analysis | prior findings B-001〜B-008-R1/B-005-R1とChatGPT-First amendment F-001〜F-004は解消済み。Issue-local PR amendmentでRQ/DES/TC/S95/S99/parent Epic planを更新中 | partially_adopted | review pending | yes | amendment candidateをcommit/pushし、fresh ChatGPT-Use `spec-reviewer`責務review |
