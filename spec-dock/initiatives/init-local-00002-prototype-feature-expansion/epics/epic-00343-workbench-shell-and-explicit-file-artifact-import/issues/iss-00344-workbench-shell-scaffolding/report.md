...
| plan | approved requirement/design、ChatGPT planning candidate、Standard assurance obligations、current provider/build/test seams、Issue plan authoring規約 | prior findingsとschema B-001〜B-007/B-005-R1をcanonical planへ修正済み。single-writer report統合、S90 dual-role gate、全no-backfill trigger、exact static path、post-commit external evidence境界を補完 | partially_adopted | failed (ChatGPT B-005-R1/B-007; fixes applied) | yes | assurance再分類、commit / push 後にfresh ChatGPT plan re-review、その後fresh `spec-reviewer` re-review |
