...
| design | approved requirement、parent Epic、provider source、current copy / package contracts、ChatGPT planning candidate / design reviews | B-001〜B-006、NB-001/NB-002をcanonical designへ修正し、post-B-006 fresh ChatGPT reviewで新規findingなし | adopted | passed (ChatGPT advisory PASS; fresh `spec-reviewer` pending) | yes | fresh `spec-reviewer` design review |
