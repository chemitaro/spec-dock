...
| design | passed requirement / Standard assurance template / provider layered architecture / existing publisher・allocator・parser / ChatGPT Pro draft | runtime profileはstandard。親critical推奨はD-004のreview inputとして保持 | partially_adopted | failed at `d5b5f2f0b1544b5e7ebdefaad658e7aebb182396`（P1×2, P2×1） | yes | D-009〜D-011を反映し再レビュー |
