...
| design | passed requirement / Standard assurance template / provider layered architecture / existing publisher・allocator・parser / ChatGPT Pro draft | runtime profileはstandard。親critical推奨はD-004のreview inputとして保持 | partially_adopted | failed at `fe33d561456b0338090b4c06528d372eb46279f6`（P2×2） | yes | D-014/D-015を反映し、planとまとめてcombined final spec review |
| plan | passed requirement / corrected canonical design / Standard assurance template / current test surfaces / Issue 346 ownership / ChatGPT Pro draft | repository誤記とD-005〜D-015由来test obligationsを補正済み | partially_adopted | pending combined final review | yes | R/D/Pを1回のChatGPT Pro combined final spec reviewで判定 |
