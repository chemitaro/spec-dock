...
- 実装 anchor `ac4c33171b6dad2dae9400072f806d94bcc615bf` より後の差分は campaign plan の `evidence_only_paths` に列挙したファイルだけに限定する。slow profile の完全な command/ledger 定義は `artifacts/final-quality-gate-check-profile.json` に保存した。
