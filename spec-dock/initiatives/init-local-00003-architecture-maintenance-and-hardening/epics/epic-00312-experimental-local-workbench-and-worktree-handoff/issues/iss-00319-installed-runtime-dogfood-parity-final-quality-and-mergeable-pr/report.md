...
| EAL-319-007 | partially_adopted | `artifacts/20260715t012925z-chatgpt-output-pr-323-workbench-parent-descriptor-repair-design.md` | external ChatGPT 5.6 Pro repair consultation | R10/F8に対してrecursive frameごとのheld source/destination fd、basename-only operations、source-before-mutation、fail-closed capability、adversarial matrixを推奨。Portable mkdir→open/leaf ABA limitsも提示 | `artifacts/20260715t012944z-disc-pr-repair-unit-workbench-descriptor-traversal.md`; provider/dogfood `fs_cli.py`; Workbench infra tests | U5 Adopted Design / Exact Invariants / Test Contract | Descriptor-bound private recursive coreとdeterministic testsを採用。Portable residualは部分採用して明示。Obvious-line-only patch、generic abstraction、pathname fallback、platform-specific stronger primitives、rollback/transactionは棄却 | advisory + byte-preserved complete transcript + repo/code/test verification | EPE-319-002; R10 review comment `3583742187`; U5 RED 4+2 / GREEN 48 / related 47 / full 2620; fresh code/QA reviews | main orchestrator | U5 code review PASS P0-P3=0; QA rereview CONDITIONAL PASS P0/P1=0、P2=2 non-blocking; final spec rereview pending | no after current record remediation; commit/external gates remain | Fresh spec pass後U5をcommit/pushし、latest-head Ubuntu CI/Codex observationを実行する |
...
| EPE-319-002 | imported_byte_exact | chatgpt-output | blank | `spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00312-experimental-local-workbench-and-worktree-handoff/issues/iss-00319-installed-runtime-dogfood-parity-final-quality-and-mergeable-pr/.workbench/pr323-workbench-parent-descriptor-repair.md` | `spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00312-experimental-local-workbench-and-worktree-handoff/issues/iss-00319-installed-runtime-dogfood-parity-final-quality-and-mergeable-pr/artifacts/20260715t012925z-chatgpt-output-pr-323-workbench-parent-descriptor-repair-design.md` | `0a0bb7f0d1a924c59e48cd583e806ab77667d72ec05cb5adfcd31723dee8740a` | 45909 | true | none | Preservationはcanonical authorityではない。U5への採用・部分採用・棄却はEAL-319-007とU5 repair unitで管理 |
