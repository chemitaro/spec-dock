...
- Epic design decisions: D-002, D-003.
- Depends on: `iss-00261`, `iss-00262`.
...
- AC-263-005 draft safety:
  - `draft-requirement`, `draft-design`, `draft-plan` は issue scope で profile-aware template を使い、invalid profile は no-write fail-closed になる。
