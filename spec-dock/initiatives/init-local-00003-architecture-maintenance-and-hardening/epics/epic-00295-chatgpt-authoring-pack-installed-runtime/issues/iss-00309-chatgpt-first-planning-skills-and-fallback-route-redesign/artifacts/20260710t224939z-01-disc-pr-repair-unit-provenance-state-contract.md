---
種別: disc
ID: "20260710t224939z-01-disc"
タイトル: "PR Repair Unit U013 Provenance State Contract"
...
# 20260710t224939z-01-disc PR Repair Unit U013 Provenance State Contract

## PR Repair Unit

- source_batch: `20260710t122133z-pr-repair-batch-pr-311-repair-batch.md`
- unit_id: `U013`
- root_cause_family: `authoring-pack.semantic-state-contract`
- covered_ids: `R022`
- decided_priority: `P1`
- merge_blocking: `yes`
- disposition: `fix-now`
...
- 根本原因: provenanceの型だけを確認し、複数fieldが構成する許容状態を検証していない。
- 設計: 純粋domain helperを追加し、ZIP/tree reviewとbackend prompt-pack検証で共有する。
- 実装手順: domain contract、application caller、CLI回帰テスト、provider/dogfood mirrorの順に変更する。
- 検証: 正常2状態、不整合状態、local-context情報欠落、ZIP/tree双方を検証する。
