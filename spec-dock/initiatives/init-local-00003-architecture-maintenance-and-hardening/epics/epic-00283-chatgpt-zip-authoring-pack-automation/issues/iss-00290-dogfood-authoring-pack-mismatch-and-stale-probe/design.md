...
# iss-00290 不一致・期限切れパックをブロックできるか検証する — 設計
...
stale profile、profile mismatch、source hash mismatch、危険な権威主張を validator がブロックできることを検証する。 そのために、入力、検証、出力、失敗時の扱いを明確に分けます。

## 責務境界

- この Issue が持つ責務: stale profile、profile mismatch、source hash mismatch、危険な権威主張を validator がブロックできることを検証する。
...
- 親 Epic trace: E-RQ-005, E-RQ-008, E-RQ-010 / E-AC-002, E-AC-004, E-AC-005, E-AC-011
- 必要な前提 Issue: iss-00285, iss-00287
- 必要に応じた source manifest、stale_if、profile snapshot。

出力:

- negative fixtures、stale / mismatch validation reports、block disposition summary
...
- 上流入力: E-RQ-005, E-RQ-008, E-RQ-010 / E-AC-002, E-AC-004, E-AC-005, E-AC-011、親 Epic の Issue readiness contract、Issue-local draft artifact の採否台帳。
- 下流出力: negative fixtures、stale / mismatch validation reports、block disposition summary
...
title iss-00290 module dependency sketch
...
spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00283-chatgpt-zip-authoring-pack-automation/issues/iss-00290-dogfood-authoring-pack-mismatch-and-stale-probe/
