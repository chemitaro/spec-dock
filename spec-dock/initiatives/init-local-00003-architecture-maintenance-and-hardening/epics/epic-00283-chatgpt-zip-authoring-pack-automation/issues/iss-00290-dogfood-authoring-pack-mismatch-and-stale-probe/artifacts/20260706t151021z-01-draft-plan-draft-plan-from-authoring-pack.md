...
intended_targets:
  - "spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00283-chatgpt-zip-authoring-pack-automation/issues/iss-00290-dogfood-authoring-pack-mismatch-and-stale-probe/plan.md"
...
- created_by_role: `chatgpt-use`
- scope_id: `iss-00290`
- intended_target: `spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00283-chatgpt-zip-authoring-pack-automation/issues/iss-00290-dogfood-authoring-pack-mismatch-and-stale-probe/plan.md`
- adoption_status: `unreviewed`
- reflected_to: `[]`
- diff_guard_result: `passed: issue-local draft artifact only; no canonical target reflected`
- report_evidence_destination: `spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00283-chatgpt-zip-authoring-pack-automation/report.md#EAL-008`
...
# iss-00290 不一致・期限切れパックをブロックできるか検証する — ドラフト実装計画
...
2. 依存関係を確認する: iss-00285, iss-00287。
3. stale profile、profile mismatch、source hash mismatch、危険な権威主張を validator がブロックできることを検証する。
4. 成果物を negative fixtures、stale / mismatch validation reports、block disposition summary として作る。
...
- negative fixtures、stale / mismatch validation reports、block disposition summary が存在する。
- 親 trace E-RQ-005, E-RQ-008, E-RQ-010 / E-AC-002, E-AC-004, E-AC-005, E-AC-011 を説明できる。
...
- その後、次 Issue `iss-00291` を `./spec-dock/scripts/spec-dock issue start iss-00291` で開始する。
