...
intended_targets:
  - "spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00283-chatgpt-zip-authoring-pack-automation/issues/iss-00285-implement-safe-authoring-pack-review-and-schema-validation/design.md"
...
- created_by_role: `chatgpt-use`
- scope_id: `iss-00285`
- intended_target: `spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00283-chatgpt-zip-authoring-pack-automation/issues/iss-00285-implement-safe-authoring-pack-review-and-schema-validation/design.md`
- adoption_status: `unreviewed`
- reflected_to: `[]`
- diff_guard_result: `passed: issue-local draft artifact only; no canonical target reflected`
- report_evidence_destination: `spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00283-chatgpt-zip-authoring-pack-automation/report.md#EAL-008`
...
# iss-00285 安全な仕様作成パック検査とスキーマ検証を実装する — ドラフト設計
...
ZIP の central directory、パス、ファイル種別、manifest、provenance、source hash、危険な権威主張を検査する。 そのために、入力、検証、出力、失敗時の扱いを明確に分けます。

## 責務境界

- この Issue が持つ責務: ZIP の central directory、パス、ファイル種別、manifest、provenance、source hash、危険な権威主張を検査する。
...
- 親 Epic trace: E-RQ-004, E-RQ-005 / E-AC-002, E-AC-003, E-AC-004
- 必要な前提 Issue: iss-00284
- 必要に応じた source manifest、stale_if、profile snapshot。

出力:

- central directory 検査、safe extraction prototype、スキーマ validator、危険な権威主張 validator
