...
intended_targets:
  - "spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00283-chatgpt-zip-authoring-pack-automation/issues/iss-00284-build-authoring-pack-preflight-and-prompt-pack/design.md"
...
- created_by_role: `chatgpt-use`
- scope_id: `iss-00284`
- intended_target: `spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00283-chatgpt-zip-authoring-pack-automation/issues/iss-00284-build-authoring-pack-preflight-and-prompt-pack/design.md`
- adoption_status: `unreviewed`
- reflected_to: `[]`
- diff_guard_result: `passed: issue-local draft artifact only; no canonical target reflected`
- report_evidence_destination: `spec-dock/initiatives/init-local-00003-architecture-maintenance-and-hardening/epics/epic-00283-chatgpt-zip-authoring-pack-automation/report.md#EAL-008`
...
# iss-00284 仕様作成パックの事前確認とプロンプトパックを作る — ドラフト設計
...
repo / ref / source_paths / stale_if / denylist / profile snapshot を固定し、ChatGPT に渡すプロンプトパックを作る。 そのために、入力、検証、出力、失敗時の扱いを明確に分けます。

## 責務境界

- この Issue が持つ責務: repo / ref / source_paths / stale_if / denylist / profile snapshot を固定し、ChatGPT に渡すプロンプトパックを作る。
...
- 事前確認 JSON スキーマ案、プロンプトパック案、ソース一覧 fixture、stale_if fixture
