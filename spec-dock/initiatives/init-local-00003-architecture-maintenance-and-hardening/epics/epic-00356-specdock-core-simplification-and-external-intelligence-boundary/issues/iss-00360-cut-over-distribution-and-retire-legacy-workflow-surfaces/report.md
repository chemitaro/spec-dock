...
* Evidence refresh HEAD: `774e126124bd5a297c4ff193b40e0c6e11061888`（Fresh mode mismatch P1修正とhard-link read-only adoption契約を含む実装tree。S95 v32はこのclean exact-upstream treeで実行した）
