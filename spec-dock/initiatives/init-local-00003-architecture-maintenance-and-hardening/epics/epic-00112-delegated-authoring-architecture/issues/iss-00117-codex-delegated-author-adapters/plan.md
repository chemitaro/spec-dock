...
- S01:
  ...
  - unblock: S02
  - 対象ファイル: src/spec_dock/assets/install_root/.codex/agents/system-architect.toml; implementation-planner.toml; .codex/agents mirrors; tests/test_init_update.py as needed
  - 閉じる要件: AC-001
