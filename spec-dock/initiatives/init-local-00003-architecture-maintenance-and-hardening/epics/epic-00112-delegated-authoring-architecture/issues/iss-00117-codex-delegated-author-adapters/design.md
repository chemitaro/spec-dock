...
# iss-00117 Codex Delegated Author Adapters — 設計（HOW）
...
- タイトル:
  - Codex adapters provider-to-consumer dependency
- 答える問い:
...
```text
.
|-- src/spec_dock/assets/...   # 変更: provider-side source of truth for Codex adapters
