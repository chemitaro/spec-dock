...
# iss-00113 Delegated Authoring Policy Foundation — 設計（HOW）
...
- 必須 / 禁止:
  - 必須: `src/spec_dock/assets/spec_dock/docs/workflow_spec_authoring.md; spec-dock/docs/workflow_spec_authoring.md` を対象に、親 Epic の該当 contract を実装可能な形にする。
...
- タイトル:
  - Policy foundation provider-to-consumer dependency
- 答える問い:
...
```text
.
|-- src/spec_dock/assets/...   # 変更: provider-side source of truth for Policy foundation
