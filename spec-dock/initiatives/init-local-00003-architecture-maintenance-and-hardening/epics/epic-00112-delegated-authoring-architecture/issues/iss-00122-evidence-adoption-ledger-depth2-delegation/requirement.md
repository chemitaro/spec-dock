...
# iss-00122 Evidence Adoption Ledger and Bounded Depth2 Delegation — 要件定義（何を、なぜ行うか）

## 目的
- epic-00112 の v1 amendment を実装可能な追加 Issue として具体化し、evidence adoption ledger and bounded depth=2 delegation policy for child specialist outputs.
...
- この Issue が閉じる親 Epic 項目: E-RQ-006, E-RQ-007, E-RQ-009, E-RQ-012 / E-AC-006, E-AC-007, E-AC-009。
- 情報源:
...
- 対象外:
  ...
  - role canonical write enablement
  - final review authority delegation
...
- AC-001:
  ...
  - 操作: Ledger records adopted, partially adopted, rejected, deferred, stale, or blocked evidence with disposition and target.
...
- AC-002:
  - アクター: spec-dock maintainer / delegated authoring orchestrator
  - 前提: epic-00112 v1 amendment is the approved parent scope.
  - 操作: Unresolved blocking ledger item prevents promotion.
  - 期待結果: The behavior is observable in provider artifacts, dogfooding evidence, or report gate evidence.
  - 観測点: issue report, managed assets, reviewer verdict, and targeted tests.
- AC-003:
  - アクター: spec-dock maintainer / delegated authoring orchestrator
  - 前提: epic-00112 v1 amendment is the approved parent scope.
  - 操作: Depth=2 graph allows authoring agents to call leaf evidence producers only.
  - 期待結果: The behavior is observable in provider artifacts, dogfooding evidence, or report gate evidence.
  - 観測点: issue report, managed assets, reviewer verdict, and targeted tests.
- AC-004:
  - アクター: spec-dock maintainer / delegated authoring orchestrator
  - 前提: epic-00112 v1 amendment is the approved parent scope.
  - 操作: Preflight reviewer output is separate from final fresh reviewer pass.
  - 期待結果: The behavior is observable in provider artifacts, dogfooding evidence, or report gate evidence.
  - 観測点: issue report, managed assets, reviewer verdict, and targeted tests.

## 例外・エッジケース
- EC-001:
  - 条件: Child agent attempts canonical edit or promotion: reject and record incident.
...
- EC-002:
  - 条件: Depth=3 delegation is forbidden.
  - 期待: fail closed, record evidence, and keep v0 workflow available.
  - 観測点: report decision ledger / reviewer finding / targeted test or inspection evidence.
- EC-003:
  - 条件: Ledger-less adoption is incomplete.
  - 期待: fail closed, record evidence, and keep v0 workflow available.
  - 観測点: report decision ledger / reviewer finding / targeted test or inspection evidence.
