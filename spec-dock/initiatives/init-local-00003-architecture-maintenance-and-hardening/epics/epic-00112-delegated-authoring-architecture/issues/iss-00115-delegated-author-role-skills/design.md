...
# iss-00115 Delegated Author Role Skills — 設計（HOW）
...
- タイトル:
  - Role skills provider-to-consumer dependency
- 答える問い:
...
```text
.
|-- src/spec_dock/assets/...   # 変更: provider-side source of truth for Role skills
