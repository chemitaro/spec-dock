...
- Do not create new files in this directory for routine work. New working artifacts use `./spec-dock/scripts/spec-dock new artifact <type> --issue <id> --title "<title>"` and target `artifacts/`.
