...
4. `spec-dock/docs/workflow_issue_planning.md`
5. `spec-dock/docs/workflow_issue_execution.md`
6. `spec-dock/docs/reference_github.md`
7. `spec-dock/docs/reference_sync.md`
8. `spec-dock/docs/reference_deps.md`
9. `spec-dock/docs/reference_naming.md`
10. `.agents/skills/spec-dock-copilot-adapter/SKILL.md`
